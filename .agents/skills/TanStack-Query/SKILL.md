...
{/_ Show pending items with visual indicator _/}
...
defaultOptions: {
queries: {
staleTime: 1000 _ 60 _ 5, // 5 min
gcTime: 1000 _ 60 _ 60, // 1 hour (v5: renamed from cacheTime)
...
staleTime: 1000 _ 60 _ 5 // 5 min - prevents excessive refetches
